...
export const routes = {
    ...
    //goals and savings
    CUSTOMERGOALS: BASEURL + '/Savings.WebApiV2/api/Savings/CustomergoalsV2',
    ...
    //savings&goals
    ADDGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/AddGoal',
    ADDFLEXIGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/AddFlexiGoal',
    ADDSTACHGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/AddStashGoal',
    FETCH_DEBITABLE_ACCOUNTS_WITH_LIMITS: BASEURL + '/PaymentApi/api/Accounts/GetAllCustomerAccountsWithLimitsV2',
    GOALTYPE: BASEURL + '/Savings.WebApiV2/api/Savings/GoalType',
    GOAL_FORMULAR: BASEURL + '/Savings.WebApiV2/api/savings/GetValues',
    GOALTRANSACTIONHISTORY: BASEURL + '/Savings.WebApiV2/api/Savings/GetCustomerGoalTransHistory',
    CUSTOMERGOALDASHBOARD: BASEURL + '/Savings.WebApiV2/api/Savings/CustomergoalDashBoard',
    TOPUPGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/TopUpGoal',
    UNPAUSEGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/ContinueGoal',
    WITHDRAWFROMGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/WithDrawal',
    DELETEGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/DeleteGoal',
    EDITGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/EditGoal',
    EDITFLEXIGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/EditFlexiGoal',
    PAUSEGOAL: BASEURL + '/Savings.WebApiV2/api/Savings/PauseGoal',
    CASHOUTSTASH:BASEURL + '/Savings.WebApiV2/api/Savings/CashoutStashGoal',

    // Group Savings
    CREATEGOAL: BASEURL + '/Savings.WebApiV2/api/GroupSaving/CreateGroup',
    GROUPCUSTOMERS: BASEURL + '/Savings.WebApiV2/api/GroupSaving/GetCustomerGroups',
    DELETE_GROUP: BASEURL + '/Savings.WebApiV2/api/GroupSaving/DeleteGroup',
    GETGROUPDETAILS: BASEURL + '/Savings.WebApiV2/api/GroupSaving/GetGroupDetails',
    SCHEDULE_CONTRIBUTION: BASEURL + '/Savings.WebApiV2/api/GroupSaving/ScheduleContribution',
    EDIT_GROUP_SAVINGS: BASEURL + '/Savings.WebApiV2/api/GroupSaving/EditGroup',
    PAUSE_GROUP: BASEURL + '/Savings.WebApiV2/api/GroupSaving/PauseScheduledGroupPayemnt',
    FIND_GROUP: BASEURL + '/Savings.WebApiV2/api/GroupSaving/FindGroup',
    JOIN_GROUP: BASEURL + '/Savings.WebApiV2/api/GroupSaving/JoinGroup',
    CONTRIBUTE: BASEURL + '/Savings.WebApiV2/api/GroupSaving/Contribute',
    
    // ROTATING SAVINGS (ESUSU)
    CREATE_ROTATING_SAVINGS: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/CreateGroup',
    ROTATING_GROUP_DETAILS: BASEURL +  '/Savings.WebApiV2/api/EsusuSaving/GetGroupDetails',
    JOIN_A_GROUP: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/JoinGroup',
    EDIT_SLOTS: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/EditSlots',
    GET_GROUPS: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/GetGroups',
    EDIT_GROUP_ESUSU: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/EditGroup',
    DELETE_GROUP_ESUSU: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/DeleteGroup',
    JOIN_GROUP_ESUSU: BASEURL + '/Savings.WebApiV2/api/EsusuSaving/JoinGroup',
    ...
    ACTIVATE_GROUP: BASEURL + '/Savings.WebApiV2/Api/EsusuSaving/Activate',
