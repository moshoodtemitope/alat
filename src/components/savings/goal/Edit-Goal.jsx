                                    ...
                                    <div className="col-sm-12">
                                        <div className="max-600">
                                            <div className="al-card no-pad">
                                                <h4 className="m-b-10 center-text hd-underline">Edit Goal</h4>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-sm-12">
                                                            <center>
                                                                ...
                                                                <button
                                                                    disabled={this.props.edit_goal.edit_customer_goal_status === customerGoalConstants.EDIT_CUSTOMER_GOAL_PENDING}

                                                                    type="submit" className="btn-alat m-t-10 m-b-20 text-center">
                                                                    {this.props.edit_goal.edit_customer_goal_status === customerGoalConstants.EDIT_CUSTOMER_GOAL_PENDING ? "Processing..." :"Edit Goal"}
