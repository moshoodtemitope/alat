...
class ForgotSecurityQuestion extends Component {
    constructor(props) {
        super(props);
        this.state = {
            answerValue: "",
    ...
    render() {
        ...
        if(this.props.pageState == 0) {
            ...
            view = <Redirect to="/settings/pin-management/forgot/verify-otp" />;
        }
        return view;
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ForgotSecurityQuestion);