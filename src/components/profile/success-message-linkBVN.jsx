...
class LinkBVNSuccessPage extends Component {
   constructor(props){
       super(props);
       this.state = {
...
ChangeResidentialStatus = () => {
   ...
   render(){
       const {residentialAddress, isBvNLinked, isToNextOfKin, navToNextOfKin, isProfileInformation, isContactDetails, isDocument } = this.state;
...
export default connect(mapStateToProps)(LinkBVNSuccessPage);
