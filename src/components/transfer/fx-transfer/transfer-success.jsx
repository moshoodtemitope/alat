...
class FxTransferSuccess extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            isSubmitted: false,
                                                ...
                                                <div className="transfer-ctn">
                                                    <div className="al-card">
                                                        ...
                                                        <div className="m-t-20 width-400">
                                                            ...
                                                            <p className="m-b-40 f-s-16">You just transfered <span className="bold-text">{currency}{this.state.transferData.AmountSent}</span> to <span className="bold-text">{this.state.transferData.AccountName}</span></p>
...
export default connect(mapStateToProps)(FxTransferSuccess);