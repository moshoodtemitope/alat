    ...
    return (dispatch) => {
        ...
        return consume
            ...
            .catch(error => {
                ...
                // dispatch(success(response.data, request));
                dispatch(failure(modelStateErrorHandler(error)));
                dispatch(alertActions.error(modelStateErrorHandler(error), returnStatusCode(error)));
                // throw(error);
            });
    };
...
export const GetSecurityquestion = () => {
    ...
    function request(request) { return { type: loanOnboardingConstants.SECURITY_QUESTION_PENDING } }
    function success(response) { return { type: loanOnboardingConstants.SECURITY_QUESTION_SUCCESS, response: response } }
    function failure(error) { return { type: loanOnboardingConstants.SECURITY_QUESTION_FAILURE, error } }
}
